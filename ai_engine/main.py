...
# Use a global session to speed up requests for multiple users
...
def fetch_activity_details(activity, location_context):
    ...
    try:
        ...
        # Using the session for faster multi-user performance
...
def generate_itinerary():
    try:
        ...
        prompt = f"Professional local consultant for {location}. {days} days, {people} people, {total_budget} INR budget. Include real hotels, restaurants, and sights. JSON only."
        ...
        for model_name in MODEL_CHAIN:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    # Parallelizing the details to speed up the response
        ...
        return jsonify({"error": "All AI models currently at capacity"}), 503
